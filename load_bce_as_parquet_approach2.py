# approach from https://www.youtube.com/watch?v=2DUcz-zCwCM
...
pwd = os.environ['BCE_PWD']
user = os.environ['BCE_USER']
# sql db details
srvr = "localhost"
...
def extract():
    try:
        engine = create_engine(f"mssql+pyodbc://{user}:{pwd}@{srvr}:1433/{db}?driver={dr}")
